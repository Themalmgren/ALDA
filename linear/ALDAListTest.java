...
public class ALDAListTest {
	...
	private ALDAList<String> listTest = createNewList();
	...
	public void testIterator2() {
		Iterator<String> i = listTest.iterator();
		
		assertEquals("1", i.next());
		i.remove();
		assertEquals("[2, 3, 4]", listTest.toString());
		assertEquals("2", i.next());
		i.remove();
		assertEquals("[3, 4]", listTest.toString());
		assertTrue(i.hasNext());
		assertEquals("3", i.next());
		i.remove();
		assertEquals("[4]", listTest.toString());
		assertTrue(i.hasNext());
		...
		listTest.add(null);
		assertEquals("[1, null]", listTest.toString());
//		
//		listTest.add(null);
//		listTest.add(null);
//		listTest.add(null);
...
//		listTest.remove(1);
//		listTest.remove(1);
//		System.out.println(listTest.indexOf(null));
//
//		listTest.remove(1);
...
//			System.out.println("------");
//			System.out.println(oracle.get(n));
